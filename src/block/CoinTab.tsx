...
function CoinTab({ coin }: CoinTabProps) {
  ...
  return (
    <div className="flex justify-between items-center p-1 px-1.5 border-b border-[#CCCCCC] text-sm hover:bg-[#F5F5F5] h-14">
      ...
      {/* 코인명 */}
      <div className="flex flex-col items-start min-w-[134px] h-full justify-center bg-emerald-50">
      ...
      <div className={`flex flex-row w-fit h-full ${coin.change === 'RISE' ? 'text-[#F1295A]' : coin.change === 'FALL' ? 'text-[#3F51B5]' : 'text-[#333333]'}`}>
        <div className="flex items-start h-full">
          <div className="flex items-end justify-end min-w-[124px] h-1/2 pr-2 bg-amber-50">
        ...
        <div className="flex-col font-light w-[100px] h-full px-1">
