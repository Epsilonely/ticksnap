# Cline's Memory Bank Configuration

**Memory Bank Location:** `docs/memory-bank/`

This project uses a shared Memory Bank system located in `docs/memory-bank/` for compatibility with both Cline and Claude Code.

## How to Use

When starting a task, read all files in `docs/memory-bank/`:
